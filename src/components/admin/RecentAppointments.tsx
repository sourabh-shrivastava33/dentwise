...
function RecentAppointments() {
  ...
  function handleToggleAppointmentStatus(appointmentId: string) {
    const changeAppointment = appointments.filter(
      (appointment) => appointment.id === appointmentId
    )?.[0];

    const newStatus =
      changeAppointment.status == "CONFIRMED" ? "COMPLETED" : "CONFIRMED";
